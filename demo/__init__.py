"""Eidolon attack/defense showcase — OPTIONAL, LOCALHOST-ONLY, NON-LOAD-BEARING.
...
``eidolon.predict.mangling``, and then — after hardening — the same attack
fails within budget.
...
- It is not imported by the Eidolon library, API, or CLI and carries no
